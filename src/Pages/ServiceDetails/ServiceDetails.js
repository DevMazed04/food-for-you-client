        ...
        <div className="d-flex flex-column flex-md-row gap-3">
          ...
          <div className="service-details">
            ...
            <div className="">
              ...
              <h3 className="form-header fw-bold ms-3 mt-5 mb-3 fs-5">
                All Reviews ({selectedReviews.length})
              </h3>

              {selectedReviews.length === 0 ? (
                <h3 className="form-header text-danger fw-semibold ms-3 mt-4 mb-3 fs-5 d-flex justify-content-center align-items-center text-center">
                  Currently this food has no reviews. Please give your first
                  review!{" "}
                </h3>
              ) : (
